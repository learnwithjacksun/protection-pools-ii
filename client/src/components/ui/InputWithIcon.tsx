  ...
  return (
    <div className="space-y-2">
        ...
        <div className="relative mt-1">
            ...
            <input ref={ref} {...props} type={type === "password" ? (showPassword ? "text" : "password") : type} className={`pl-12 h-11 w-full rounded-lg text-sm border border-line focus:border-primary focus:ring-4 focus:ring-primary/10 ${props.className}`} />
